(function() {
  ...
  Backbone.UI.Util.autohide = function(els, options) {
  ...
  */
  Backbone.UI.Util.alignTo = function(els, anchor, pos, xFudge, yFudge, container) {
  ...
  Backbone.UI.Util.find = function(el, selector) {
    return el.querySelectorAll(selector);
  };
  
  Backbone.UI.Util.getStyle = function(el, style) {
      var computedStyle;
  ...
  Backbone.UI.Util.offset = function(el) {
  ...
  Backbone.UI.Util.remove = function(el) {
    if(el && el.parentNode) {
